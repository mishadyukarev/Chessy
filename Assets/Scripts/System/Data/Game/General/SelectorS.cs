                    ...
                    else
                    {
                        switch (E.CellClickTC.Click)
                        {
                            ...
                            case CellClickTypes.SimpleClick:
                                {
                                    if (E.SelectedIdxC.Idx > 0)
                                    {
                                        ...
                                        {
                                            E.RpcE.AttackUnitToMaster(E.SelectedIdxC.Idx, E.CurrentIdxC.Idx);
                                        }

                                        else if (E.UnitEs(E.SelectedIdxC.Idx).ForShift.Contains(E.CurrentIdxC.Idx))
                                        {
                                            E.RpcE.ShiftUnitToMaster(E.SelectedIdxC.Idx, E.CurrentIdxC.Idx);
                                        }
                            ...
                            case CellClickTypes.SetUnit:
                                {
                                    E.RpcE.SetUniToMaster(E.CurrentIdxC.Idx, E.SelectedUnitE.UnitTC.Unit);
                            ...
                            case CellClickTypes.GiveTakeTW:
                                {
                                    ...
                                    {
                                        E.RpcE.GiveTakeToolWeaponToMaster(E.CurrentIdxC.Idx, E.SelectedTWE.ToolWeaponTC.ToolWeapon, E.SelectedTWE.LevelTC.Level);
                                    }
                                    else
                                    {
                                        E.CellClickTC.Click = CellClickTypes.SimpleClick;
                            ...
                            case CellClickTypes.UniqueAbility:
                                {
                                    switch (E.SelectedAbilityTC.Ability)
                                    {
                                        case AbilityTypes.FireArcher:
                                            E.RpcE.FireArcherToMas(E.SelectedIdxC.Idx, E.CurrentIdxC.Idx);
                                            break;

                                        case AbilityTypes.StunElfemale:
                                            E.RpcE.StunElfemaleToMas(E.SelectedIdxC.Idx, E.CurrentIdxC.Idx);
                                            break;
                                        ...
                                        case AbilityTypes.ChangeDirectionWind:
                                            {
                                                foreach (var cellE in E.CellEs(E.CenterCloudIdxC.Idx).AroundCellEs)
                                                {
                                                    ...
                                                    {
                                                        E.RpcE.PutOutFireElffToMas(E.SelectedIdxC.Idx, E.CurrentIdxC.Idx);
                                                    }
                                                }
                                            }
                                            break;
                                        ...
                                        case AbilityTypes.DirectWave:
                                            E.RpcE.DirectWaveToMaster(E.SelectedIdxC.Idx, E.CurrentIdxC.Idx);
                                            break;

                                        case AbilityTypes.Resurrect:
                                            E.RpcE.ResurrectToMaster(E.SelectedIdxC.Idx, E.CurrentIdxC.Idx);
                                            break;
                            ...
                            case CellClickTypes.CityBuildBuilding:
                                {
                                    E.RpcE.CityBuildToMaster(E.SelectedBuildingTC.Build, E.SelectedIdxC.Idx, E.CurrentIdxC.Idx);
                                    E.CellClickTC.Click = CellClickTypes.SimpleClick;
                                }
                                break;
