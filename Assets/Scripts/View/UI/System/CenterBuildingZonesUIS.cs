...
namespace Chessy.Model
{
    sealed class CenterBuildingZonesUIS : SystemUIAbstract
    {
        ...
        internal CenterBuildingZonesUIS(in EntitiesViewUI entsUI, in Chessy.Model.Model.Entity.EntitiesModel ents) : base(ents)
        {
            eUI = entsUI;
        }
        ...
        {
            eUI.CenterEs.MarketE.Zone.SetActive(_e.SelectedE.BuildingsC.Is(BuildingTypes.Market));
            eUI.CenterEs.SmelterE.Zone.SetActive(_e.SelectedE.BuildingsC.Is(BuildingTypes.Smelter));
