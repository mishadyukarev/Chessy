...
public sealed class EntGameGeneralUIViewManager
{
    ...
    internal EntGameGeneralUIViewManager(EcsWorld gameWorld)
    {

        _leaveEnt = gameWorld.NewEntity()
            .Replace(new ButtonComponent(CanvasUIViewContainer.FindUnderParent<Button>(SceneTypes.Game, "ButtonLeave")));


        #region Center

        var middleZone = CanvasUIViewContainer.FindUnderParent(SceneTypes.Game, "MiddleZone");

        var theEndGameZone = CanvasUIViewContainer.FindUnderParent(SceneTypes.Game, "TheEndGameZone");
        ...
        var readyZone = CanvasUIViewContainer.FindUnderParent(SceneTypes.Game, "ReadyZone");
        ...
        var motionZone = CanvasUIViewContainer.FindUnderParent(SceneTypes.Game, "MotionZone");
        ...
        var upZoneGO = CanvasUIViewContainer.FindUnderParent(SceneTypes.Game, "UpZone");
        ...
        var downZone = CanvasUIViewContainer.FindUnderParent(SceneTypes.Game, "DownZone");
        ...
        var leftZoneGO = CanvasUIViewContainer.FindUnderParent(SceneTypes.Game, "LeftZone");
        ...
        var rightZoneGO = CanvasUIViewContainer.FindUnderParent(SceneTypes.Game, "RightZone");
