...
public sealed class EntViewGameGeneralUIManager
{
    ...
    internal EntViewGameGeneralUIManager(EcsWorld gameWorld)
    {

        _leaveEnt = gameWorld.NewEntity()
            .Replace(new ButtonComponent(ViewCommonContainerUICanvas.FindUnderParent<Button>(SceneTypes.Game, "ButtonLeave")));


        #region Center

        var middleZone = ViewCommonContainerUICanvas.FindUnderParent(SceneTypes.Game, "MiddleZone");

        var theEndGameZone = ViewCommonContainerUICanvas.FindUnderParent(SceneTypes.Game, "TheEndGameZone");
        ...
        var readyZone = ViewCommonContainerUICanvas.FindUnderParent(SceneTypes.Game, "ReadyZone");
        ...
        var motionZone = ViewCommonContainerUICanvas.FindUnderParent(SceneTypes.Game, "MotionZone");
        ...
        var upZoneGO = ViewCommonContainerUICanvas.FindUnderParent(SceneTypes.Game, "UpZone");
        ...
        var downZone = ViewCommonContainerUICanvas.FindUnderParent(SceneTypes.Game, "DownZone");
        ...
        var leftZoneGO = ViewCommonContainerUICanvas.FindUnderParent(SceneTypes.Game, "LeftZone");
        ...
        var rightZoneGO = ViewCommonContainerUICanvas.FindUnderParent(SceneTypes.Game, "RightZone");
