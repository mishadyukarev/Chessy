...
namespace Assets.Scripts.ECS.Entities.Game.General.Cells.View
{
    public sealed class EntGameGeneralCellViewManager
    {
        internal EntGameGeneralCellViewManager(EcsWorld gameWorld, EntCommonManager entCommonManager)
        {
            ...
            new CellBlocksViewContainer(cellGOs, gameWorld);
            new CellSupVisBarsContainer(cellGOs, gameWorld);
            new CellSupVisViewContainer(cellGOs, gameWorld);
            new CellFireViewContainer(cellGOs, gameWorld);
            new CellUnitViewContainer(cellGOs, gameWorld);
            new CellBuildingViewContainer(cellGOs, gameWorld);
            new CellEnvirViewContainer(cellGOs, gameWorld);
            new CellViewContainer(cellGOs, gameWorld);
