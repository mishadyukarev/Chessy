...
{
    public sealed class EntMenuManager
    {
        ...
        internal EntMenuManager(EcsWorld menuWorld, EntCommonManager entCommonManager)
        {
            ...
            slider.value = entCommonManager.SaverEnt_SaverCommCom.SliderVolume;
            ...
            var rightZone = CanvasUIViewContainer.FindUnderParent<RectTransform>(SceneTypes.Menu, "OnlineRightZone");
            ...
            var leftZone = CanvasUIViewContainer.FindUnderParent<RectTransform>(SceneTypes.Menu, "OfflineLeftZone");
