...
{
    public sealed class EntCommonManager
    {
        ...
        internal EntCommonManager(EcsWorld commonWorld)
        {
        ...
        internal void OwnUpdate(SceneTypes sceneType, EntMenuManager entMenuManager)
        {
            switch (sceneType)
            {
                ...
                case SceneTypes.Menu:
                    ...
                    SaverEnt_StepModeTypeCom.StepModeType = entMenuManager.StepModUIEnt_DropDownTMPCom.StepModValue;
                    break;
        ...
        internal void ToggleScene(SceneTypes sceneType)
        {
            switch (sceneType)
            {
                ...
                case SceneTypes.Menu:
                    ...
                    CanvasUIViewContainer.DestroyZoneUI(SceneTypes.Game);

                    CanvasUIViewContainer.SetZoneUI(SceneTypes.Menu, ResourcesEnt_ResourcesCommonCom);

                    var slider = CanvasUIViewContainer.FindUnderParent<Slider>(SceneTypes.Menu, "Slider");
                    break;
                ...
                case SceneTypes.Game:
                    ...
                    CanvasUIViewContainer.DestroyZoneUI(SceneTypes.Menu);

                    CanvasUIViewContainer.SetZoneUI(SceneTypes.Game, ResourcesEnt_ResourcesCommonCom);
