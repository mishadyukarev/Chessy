...
{
    public struct CellEnvirDataContainer
    {
        ...
        internal CellEnvirDataContainer(EcsWorld gameWorld)
        {
        ...
        internal static bool HaveEnvironment(EnvironmentTypes environmentType, int[] xy)
        {
            switch (environmentType)
            {
                ...
                case EnvironmentTypes.Fertilizer:
                    return _cellFertilizerEnts[xy[X], xy[Y]].Get<HaveEnvironmentComponent>().HaveEnvironment;

                case EnvironmentTypes.YoungForest:
                    return _cellYoungForestEnts[xy[X], xy[Y]].Get<HaveEnvironmentComponent>().HaveEnvironment;

                case EnvironmentTypes.AdultForest:
                    return _cellAdultForestEnts[xy[X], xy[Y]].Get<HaveEnvironmentComponent>().HaveEnvironment;

                case EnvironmentTypes.Hill:
                    return _cellHillEnts[xy[X], xy[Y]].Get<HaveEnvironmentComponent>().HaveEnvironment;

                case EnvironmentTypes.Mountain:
                    return _cellMountainEnts[xy[X], xy[Y]].Get<HaveEnvironmentComponent>().HaveEnvironment;
