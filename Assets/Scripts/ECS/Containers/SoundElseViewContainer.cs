...
namespace Assets.Scripts.ECS.Entities.Game.General.Else.View.Containers
{
    internal sealed class SoundElseViewContainer
    {
        ...
        internal SoundElseViewContainer(EcsWorld gameWorld)
        {
            ...
            MainCommonSystem.ToggleZoneEnt_ParentCom.Attach(audioSourceParentGO.transform);

            MistakeAudioSource = audioSourceParentGO.AddComponent<AudioSource>();
            MistakeAudioSource.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.MistakeAudioClip;

            AttackAudioSource = audioSourceParentGO.AddComponent<AudioSource>();
            AttackAudioSource.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.AttackSwordAudioClip;



            var attackAS = audioSourceParentGO.AddComponent<AudioSource>();
            attackAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.AttackArcherAC;
            ...
            pickArcherAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.PickArcherAudioClip;
            ...
            pickMeleeAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.PickMeleeAC;
            ...
            buildingAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.BuildingAC;
            ...
            settingAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.SettingUnitAC;
            ...
            fireAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.FireAC;
            fireAS.volume = 0.2f;
            ...
            buyAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.BuyAC;
            buyAS.volume = 0.3f;
            ...
            meltingAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.Melting_Clip;
            ...
            destroyAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.Destroy_Clip;
            ...
            upgradeUnitMeleeAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.UpgradeUnitMelee_Clip;
            ...
            seedingAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.Seeding_Clip;
            ...
            shiftUnitAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.ShiftUnit_Clip;
            ...
            truceAS.clip = MainCommonSystem.ResourcesEnt_ResourcesCommonCom.SoundConfig.Truce_Clip;
            truceAS.volume = 0.6f;
