...
internal sealed class UpdateMotionMasterSystem : SystemMasterReduction
{
    ...
    public override void Run()
    {
                ...
                if (_eGM.CellBuilEnt_BuilTypeCom(x, y).HaveBuilding)
                {
                    switch (_eGM.CellBuilEnt_BuilTypeCom(x, y).BuildingType)
                    {
                        ...
                        case BuildingTypes.Farm:
                            _eGM.CellEnvEnt_CellEnvCom(x, y).AmountFertilizerResources -= (int)(Instance.ECSmanagerGame.EntitiesCommonManager.ResourcesEnt_ResourcesCommonCom.StartValuesGameConfig.BENEFIT_FOOD_FARM + (0.25f * _eGM.BuildingsEnt_UpgradeBuildingsCom.AmountUpgrades(BuildingTypes.Farm, _eGM.CellBuilEnt_OwnerCom(x, y).IsMasterClient)));
                        ...
                        case BuildingTypes.Woodcutter:
                            _eGM.CellEnvEnt_CellEnvCom(x, y).AmountForestResources -= (int)(Instance.ECSmanagerGame.EntitiesCommonManager.ResourcesEnt_ResourcesCommonCom.StartValuesGameConfig.BENEFIT_WOOD_WOODCUTTER + (0.25f * _eGM.BuildingsEnt_UpgradeBuildingsCom.AmountUpgrades(BuildingTypes.Woodcutter, _eGM.CellBuilEnt_OwnerCom(x, y).IsMasterClient)));
                        ...
                        case BuildingTypes.Mine:
                            _eGM.CellEnvEnt_CellEnvCom(x, y).AmountOreResources -= (int)(Instance.ECSmanagerGame.EntitiesCommonManager.ResourcesEnt_ResourcesCommonCom.StartValuesGameConfig.BENEFIT_ORE_MINE + (0.25f * _eGM.BuildingsEnt_UpgradeBuildingsCom.AmountUpgrades(BuildingTypes.Mine, _eGM.CellBuilEnt_OwnerCom(x, y).IsMasterClient)));
        ...
        _eGM.EconomyEnt_EconomyCom.AddFood(true, (int)(_eGM.BuildingsEnt_BuildingsCom.AmountBuildings(BuildingTypes.Farm, true) * (Instance.ECSmanagerGame.EntitiesCommonManager.ResourcesEnt_ResourcesCommonCom.StartValuesGameConfig.BENEFIT_FOOD_FARM + (0.25f * _eGM.BuildingsEnt_UpgradeBuildingsCom.AmountUpgrades(BuildingTypes.Farm, true)))));
        _eGM.EconomyEnt_EconomyCom.AddFood(false, (int)(_eGM.BuildingsEnt_BuildingsCom.AmountBuildings(BuildingTypes.Farm, false) * (Instance.ECSmanagerGame.EntitiesCommonManager.ResourcesEnt_ResourcesCommonCom.StartValuesGameConfig.BENEFIT_FOOD_FARM + (0.25f * _eGM.BuildingsEnt_UpgradeBuildingsCom.AmountUpgrades(BuildingTypes.Farm, false)))));

        _eGM.EconomyEnt_EconomyCom.AddWood(true, (int)(_eGM.BuildingsEnt_BuildingsCom.AmountBuildings(BuildingTypes.Woodcutter, true) * (Instance.ECSmanagerGame.EntitiesCommonManager.ResourcesEnt_ResourcesCommonCom.StartValuesGameConfig.BENEFIT_WOOD_WOODCUTTER + (0.25f * _eGM.BuildingsEnt_UpgradeBuildingsCom.AmountUpgrades(BuildingTypes.Woodcutter, true)))));
        _eGM.EconomyEnt_EconomyCom.AddWood(false, (int)(_eGM.BuildingsEnt_BuildingsCom.AmountBuildings(BuildingTypes.Woodcutter, false) * (Instance.ECSmanagerGame.EntitiesCommonManager.ResourcesEnt_ResourcesCommonCom.StartValuesGameConfig.BENEFIT_WOOD_WOODCUTTER + (0.25f * _eGM.BuildingsEnt_UpgradeBuildingsCom.AmountUpgrades(BuildingTypes.Woodcutter, false)))));

        _eGM.EconomyEnt_EconomyCom.AddOre(true, (int)(_eGM.BuildingsEnt_BuildingsCom.AmountBuildings(BuildingTypes.Mine, true) * (Instance.ECSmanagerGame.EntitiesCommonManager.ResourcesEnt_ResourcesCommonCom.StartValuesGameConfig.BENEFIT_ORE_MINE + (0.25f * _eGM.BuildingsEnt_UpgradeBuildingsCom.AmountUpgrades(BuildingTypes.Mine, true)))));
        _eGM.EconomyEnt_EconomyCom.AddOre(false, (int)(_eGM.BuildingsEnt_BuildingsCom.AmountBuildings(BuildingTypes.Mine, false) * (Instance.ECSmanagerGame.EntitiesCommonManager.ResourcesEnt_ResourcesCommonCom.StartValuesGameConfig.BENEFIT_ORE_MINE + (0.25f * _eGM.BuildingsEnt_UpgradeBuildingsCom.AmountUpgrades(BuildingTypes.Mine, false)))));
