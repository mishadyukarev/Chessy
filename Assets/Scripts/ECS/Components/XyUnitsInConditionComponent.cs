...
{
    internal struct XyUnitsInConditionComponent
    {
        ...
        internal XyUnitsInConditionComponent((Dictionary<bool, List<int[]>>, Dictionary<bool, List<int[]>>, Dictionary<bool, List<int[]>>) dicts)
        {
