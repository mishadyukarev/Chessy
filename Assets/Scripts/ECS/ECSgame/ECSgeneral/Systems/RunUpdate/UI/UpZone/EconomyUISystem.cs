...
internal sealed class EconomyUISystem : SystemGeneralReduction
{
    public override void Run()
    {
        ...
        _eGM.EconomyUIEnt_EconomyUICom.SetText(EconomyTypes.Food, _eGM.EconomyEnt_EconomyCom.Food(Instance.IsMasterClient).ToString());
        _eGM.EconomyUIEnt_EconomyUICom.SetText(EconomyTypes.Wood, _eGM.EconomyEnt_EconomyCom.Wood(Instance.IsMasterClient).ToString());
