...
internal struct UnitInventorComponent : IDisposable
{
    ...
    public void Dispose()
    {
        _amountKingDict[true] = default;
        _amountKingDict[false] = default;

        _amountPawnDict[true] = default;
        _amountPawnDict[false] = default;

        _amountRookDict[true] = default;
        _amountRookDict[false] = default;

        _amountBishopDict[true] = default;
        _amountBishopDict[false] = default;
    }
}
