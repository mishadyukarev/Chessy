...
namespace Assets.Scripts.ECS.System.View.Game.General.Cell
{
    internal sealed class StartSpawnCellsViewSystem : IEcsInitSystem
    {
        ...
        public void Init()
        {
            var cellGO = MainDataCommSys.ResourcesEnt_ResourcesCommonCom.PrefabConfig.CellGO;
            var whiteCellSR = MainDataCommSys.ResourcesEnt_ResourcesCommonCom.SpritesConfig.WhiteSprite;
            var blackCellSR = MainDataCommSys.ResourcesEnt_ResourcesCommonCom.SpritesConfig.BlackSprite;

            CellGOs = new GameObject[CELL_COUNT_X, CELL_COUNT_Y];

            var supportParentForCells = new GameObject("Cells");
            MainDataCommSys.ToggleZoneEnt_ParentCom.Attach(supportParentForCells.transform);
