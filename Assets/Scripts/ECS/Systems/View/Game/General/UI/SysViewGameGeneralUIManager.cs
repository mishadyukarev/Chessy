...
namespace Assets.Scripts.ECS.System.View.Game.General.UI
{
    public sealed class SysViewGameGeneralUIManager : SystemAbstManager
    {
        #region Center
        ...
        internal SysViewGameGeneralUIManager(EcsWorld gameWorld) : base(gameWorld)
        {
            _leaveEnt = gameWorld.NewEntity()
                .Replace(new ButtonComponent(MainCommonViewSys.CanvasEnt_CanvasCom.FindUnderParent<Button>(SceneTypes.Game, "ButtonLeave")));


            #region Center

            var middleZone = MainCommonViewSys.CanvasEnt_CanvasCom.FindUnderParent(SceneTypes.Game, "MiddleZone");

            var theEndGameZone = MainCommonViewSys.CanvasEnt_CanvasCom.FindUnderParent(SceneTypes.Game, "TheEndGameZone");
            ...
            var readyZone = MainCommonViewSys.CanvasEnt_CanvasCom.FindUnderParent(SceneTypes.Game, "ReadyZone");
            ...
            var motionZone = MainCommonViewSys.CanvasEnt_CanvasCom.FindUnderParent(SceneTypes.Game, "MotionZone");
            ...
            var upZoneGO = MainCommonViewSys.CanvasEnt_CanvasCom.FindUnderParent(SceneTypes.Game, "UpZone");

            new ResourcesViewUIWorker(gameWorld, upZoneGO);
            ...
            var downZone = MainCommonViewSys.CanvasEnt_CanvasCom.FindUnderParent(SceneTypes.Game, "DownZone");
            ...
            var leftZoneGO = MainCommonViewSys.CanvasEnt_CanvasCom.FindUnderParent(SceneTypes.Game, "LeftZone");
            ...
            var rightZoneGO = MainCommonViewSys.CanvasEnt_CanvasCom.FindUnderParent(SceneTypes.Game, "RightZone");
