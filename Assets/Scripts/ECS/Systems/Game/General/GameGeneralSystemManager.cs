...
public sealed class GameGeneralSystemManager : SystemAbstManager
{
    ...
    .Replace(new ButtonComponent(MainCommonSystem.CanvasEnt_CanvasCom.FindUnderParent<Button>("ButtonLeave")));


        #region Center

        var middleZone = MainCommonSystem.CanvasEnt_CanvasCom.FindUnderParent("MiddleZone");

        var theEndGameZone = MainCommonSystem.CanvasEnt_CanvasCom.FindUnderParent("TheEndGameZone");
        ...
        var readyZone = MainCommonSystem.CanvasEnt_CanvasCom.FindUnderParent("ReadyZone");
        ...
        var motionZone = MainCommonSystem.CanvasEnt_CanvasCom.FindUnderParent("MotionZone");
        ...
        var upZoneGO = MainCommonSystem.CanvasEnt_CanvasCom.FindUnderParent("UpZone");
        ...
        var downZone = MainCommonSystem.CanvasEnt_CanvasCom.FindUnderParent("DownZone");
        ...
        var leftZoneGO = MainCommonSystem.CanvasEnt_CanvasCom.FindUnderParent("LeftZone");
        ...
        var rightZoneGO = MainCommonSystem.CanvasEnt_CanvasCom.FindUnderParent("RightZone");
