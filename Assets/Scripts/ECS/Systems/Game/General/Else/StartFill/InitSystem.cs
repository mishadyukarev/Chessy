...
namespace Assets.Scripts.ECS.Game.General.Systems.StartFill
{
    internal sealed class InitSystem : IEcsInitSystem
    {
        ...
        public void Init()
        {
            BackGroundGO = GameObject.Instantiate(MainCommonSystem.ResourcesEnt_ResourcesCommonCom.PrefabConfig.BackGroundCollider2D,
                Main.Instance.transform.position + new Vector3(7, 5.5f, 2), Main.Instance.transform.rotation);

            MainCommonSystem.ToggleZoneEnt_ParentCom.Attach(BackGroundGO.transform);
