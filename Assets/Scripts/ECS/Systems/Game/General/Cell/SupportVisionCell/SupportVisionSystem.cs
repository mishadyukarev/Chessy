...
internal sealed class SupportVisionSystem : IEcsRunSystem
{
    ...
    public void Run()
    {
        ...
        SelectorSystem.AvailableCellsCom.GetAllCellsCopy(AvailableCellTypes.Shift).ForEach((xy) => CellSupViewSystem.EnableSupVis(SupportVisionTypes.Shift, xy));
        SelectorSystem.AvailableCellsCom.GetAllCellsCopy(AvailableCellTypes.SimpleAttack).ForEach((xy) => CellSupViewSystem.EnableSupVis(SupportVisionTypes.SimpleAttack, xy));
        SelectorSystem.AvailableCellsCom.GetAllCellsCopy(AvailableCellTypes.UniqueAttack).ForEach((xy) => CellSupViewSystem.EnableSupVis(SupportVisionTypes.UniqueAttack, xy));
    }
}
