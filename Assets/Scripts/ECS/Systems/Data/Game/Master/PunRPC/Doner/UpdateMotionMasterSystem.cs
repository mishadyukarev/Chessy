...
internal sealed class UpdateMotionMasterSystem : SystemMasterReduction
{
    ...
    public override void Run()
    {
        ...
        Main.Instance.ECSmanager.SysViewGameGeneralUIManager.MotionEnt_AmountCom.AmountMotions += 1;
        ...
        if (amountAdultForest <= 3)
        {
            ...
            SysDataGameMasterManager.TryInvokeRunSystem(nameof(TruceMasterSystem), SysDataGameMasterManager.RpcSystems);
        }
    }
}
