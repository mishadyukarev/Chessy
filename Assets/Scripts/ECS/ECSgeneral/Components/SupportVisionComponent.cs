...
public struct SupportVisionComponent
{
    ...
    {
        _supportVisioTypeIN = SupportVisionTypes.SelectorVision;
    ...
    {
        _supportVisioTypeIN = SupportVisionTypes.SpawnVision;
    ...
    {
        _supportVisioTypeIN = SupportVisionTypes.WayOfUnitVision;
    ...
    {
        _supportVisioTypeIN = SupportVisionTypes.EnemyVision;
