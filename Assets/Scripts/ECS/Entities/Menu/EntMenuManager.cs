...
{
    public sealed class EntMenuManager : EntitiesManager
    {
        ...
        internal EntMenuManager(EcsWorld menuWorld)
        {
            ...
            slider.value = Instance.ECSmanager.EntCommonManager.SaverEnt_SaverCommCom.SliderVolume;
            ...
            var rightZone = CanvasUIWorker.FindUnderParent<RectTransform>(SceneTypes.Menu, "OnlineRightZone");
            ...
            var leftZone = CanvasUIWorker.FindUnderParent<RectTransform>(SceneTypes.Menu, "OfflineLeftZone");
