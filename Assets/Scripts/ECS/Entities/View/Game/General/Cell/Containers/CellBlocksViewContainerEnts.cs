...
{
    internal sealed class CellBlocksViewContainerEnts : CellEntsAbstractContainer
    {
        ...
        internal CellBlocksViewContainerEnts(GameObject[,] cellParentGOs, EcsWorld gameWorld) : base(cellParentGOs)
        {
