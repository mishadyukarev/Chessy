...
{
    internal sealed class CellViewContainerEnts : CellEntsAbstractContainer
    {
        ...
        internal CellViewContainerEnts(GameObject[,] cellParentGOs, EcsWorld gameWorld) : base(cellParentGOs)
        {
