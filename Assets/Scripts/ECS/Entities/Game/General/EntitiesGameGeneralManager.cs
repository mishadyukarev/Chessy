...
public sealed class EntitiesGameGeneralManager : EntitiesManager
{
    ...
    internal EntitiesGameGeneralManager(EcsWorld gameWorld)
    {
        ...
        BackGroundGO.transform.SetParent(Instance.ECSmanager.EntitiesCommonManager.ToggleSceneParentGOZoneEnt_ParentCom.ParentGO.transform);
    ...
    private void SpawnAndCreateCellsEnts(EcsWorld gameWorld)
    {
        ...
        supportParentForCells.transform.SetParent(Instance.ECSmanager.EntitiesCommonManager.ToggleSceneParentGOZoneEnt_ParentCom.ParentGO.transform);
    ...
    private void CreateSound(EcsWorld gameWorld)
    {
        ...
        audioSourceParentGO.transform.SetParent(Instance.ECSmanager.EntitiesCommonManager.ToggleSceneParentGOZoneEnt_ParentCom.ParentGO.transform);
