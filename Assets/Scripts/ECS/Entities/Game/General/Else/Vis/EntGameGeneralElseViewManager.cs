...
namespace Assets.Scripts.ECS.Entities.Game.General.Else.Vis
{
    public sealed class EntGameGeneralElseViewManager
    {
        ...
        internal EntGameGeneralElseViewManager(EcsWorld gameWorld)
        {
            var audioSourceParentGO = new GameObject("AudioSource");
            audioSourceParentGO.transform.SetParent(Instance.ECSmanager.EntCommonManager.ToggleSceneParentGOZoneEnt_ParentCom.ParentGO.transform);

            MistakeAudioSource = audioSourceParentGO.AddComponent<AudioSource>();
            MistakeAudioSource.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.MistakeAudioClip;

            AttackAudioSource = audioSourceParentGO.AddComponent<AudioSource>();
            AttackAudioSource.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.AttackSwordAudioClip;


            var attackAS = audioSourceParentGO.AddComponent<AudioSource>();
            attackAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.AttackArcherAC;
            ...
            pickArcherAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.PickArcherAudioClip;
            ...
            pickMeleeAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.PickMeleeAC;
            ...
            buildingAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.BuildingAC;
            ...
            settingAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.SettingUnitAC;
            ...
            fireAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.FireAC;
            fireAS.volume = 0.2f;
            ...
            buyAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.BuyAC;
            buyAS.volume = 0.3f;
            ...
            meltingAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.Melting_Clip;
            ...
            destroyAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.Destroy_Clip;
            ...
            upgradeUnitMeleeAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.UpgradeUnitMelee_Clip;
            ...
            seedingAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.Seeding_Clip;
            ...
            shiftUnitAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.ShiftUnit_Clip;
            ...
            truceAS.clip = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SoundConfig.Truce_Clip;
            truceAS.volume = 0.6f;
