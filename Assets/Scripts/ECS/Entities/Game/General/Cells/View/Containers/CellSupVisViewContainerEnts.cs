...
{
    internal sealed class CellSupVisViewContainerEnts : CellEntsAbstractContainer
    {
        ...
        internal CellSupVisViewContainerEnts(GameObject[,] cellParentGOs, EcsWorld gameWorld) : base(cellParentGOs)
        {
