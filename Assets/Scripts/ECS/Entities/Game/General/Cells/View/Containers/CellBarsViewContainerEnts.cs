...
{
    internal sealed class CellBarsViewContainerEnts : CellEntsAbstractContainer
    {
        ...
        internal CellBarsViewContainerEnts(GameObject[,] cellParent, EcsWorld gameWorld) : base(cellParent)
        {
