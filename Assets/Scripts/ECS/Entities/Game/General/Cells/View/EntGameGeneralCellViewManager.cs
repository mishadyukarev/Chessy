...
namespace Assets.Scripts.ECS.Entities.Game.General.Cells.View
{
    public sealed class EntGameGeneralCellViewManager
    {
        ...
        internal EntGameGeneralCellViewManager(EcsWorld gameWorld)
        {
            var cellGO = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.PrefabConfig.CellGO;
            var whiteCellSR = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SpritesConfig.WhiteSprite;
            var blackCellSR = Instance.ECSmanager.EntCommonManager.ResourcesEnt_ResourcesCommonCom.SpritesConfig.BlackSprite;

            var cellGOs = new GameObject[CELL_COUNT_X, CELL_COUNT_Y];

            var supportParentForCells = new GameObject("Cells");
            supportParentForCells.transform.SetParent(Instance.ECSmanager.EntCommonManager.ToggleSceneParentGOZoneEnt_ParentCom.ParentGO.transform);
