...
namespace Assets.Scripts.ECS.Component
{
    internal struct UnitsInConditionInGameCom
    {
        ...
        internal bool TryFindUnitInCondition(ConditionUnitTypes protectRelaxType, UnitTypes unitType, bool key, byte idxCell) => GetUnitsInCondition(protectRelaxType, unitType, key).TryFindCell(idxCell);
        ...
        internal void RemoveUnitInCondition(ConditionUnitTypes protectRelaxType, UnitTypes unitType, bool key, byte idxCellForTaking) { if (!GetUnitsInCondition(protectRelaxType, unitType, key).TryFindCellInListAndRemove(idxCellForTaking)) throw new Exception(); }
