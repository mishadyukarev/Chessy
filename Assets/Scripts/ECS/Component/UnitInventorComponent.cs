...
namespace Assets.Scripts.ECS.Component
{
    internal struct UnitInventorComponent
    {
        ...
        internal UnitInventorComponent(Dictionary<UnitTypes, Dictionary<bool, int>> dict)
        {
        ...
        internal void AddUnitsInInventor(UnitTypes unitType, bool key, int adding = 1)
            => SetAmountUnitsInInventor(unitType, key, AmountUnitsInInventor(unitType, key) + adding);
        internal void TakeUnitsInInventor(UnitTypes unitType, bool key, int taking = 1)
