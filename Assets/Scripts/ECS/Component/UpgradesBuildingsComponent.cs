...
namespace Assets.Scripts.ECS.Component
{
    internal struct UpgradesBuildingsComponent
    {
        ...
        internal int AmountUpgrades(BuildingTypes buildingType, bool key) => _amountUpgradesDict[buildingType][key];
        internal int SetAmountUpgrades(BuildingTypes buildingType, bool key, int value) => _amountUpgradesDict[buildingType][key] = value;

        internal void AddAmountUpgrades(BuildingTypes buildingType, bool key, int adding = 1) => SetAmountUpgrades(buildingType, key, AmountUpgrades(buildingType, key) + adding);
        internal void TakeAmountUpgrades(BuildingTypes buildingType, bool key, int taking = 1) => SetAmountUpgrades(buildingType, key, AmountUpgrades(buildingType, key) - taking);
    }
}
