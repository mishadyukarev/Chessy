...
internal sealed class CellUnitWorker : CellWorker
{
    ...
    internal CellUnitWorker(ECSmanagerGame eCSmanager, CellBaseOperations cellBaseOperations) : base(eCSmanager)
    {
    ...
    internal int MaxAmountHealth(params int[] xy)
    {
        switch (_eGM.CellUnitEnt_UnitTypeCom(xy).UnitType)
        {
            ...
            case UnitTypes.Pawn:
                return _startValuesGameConfig.AMOUNT_HEALTH_PAWN + _eGM.InfoEnt_UpgradeInfoCom.AmountUpgradePawnDict[_eGM.CellUnitEnt_CellOwnerCom(xy).IsMasterClient] * _startValuesGameConfig.HEALTH_UPGRADE_ADDING_PAWN;

            case UnitTypes.Rook:
                return _startValuesGameConfig.AMOUNT_HEALTH_ROOK + _eGM.InfoEnt_UpgradeInfoCom.AmountUpgradeRookDict[_eGM.CellUnitEnt_CellOwnerCom(xy).IsMasterClient] * _startValuesGameConfig.HEALTH_UPGRADE_ADDING_ROOK;

            case UnitTypes.Bishop:
                return _startValuesGameConfig.AMOUNT_HEALTH_BISHOP + _eGM.InfoEnt_UpgradeInfoCom.AmountUpgradeBishopDict[_eGM.CellUnitEnt_CellOwnerCom(xy).IsMasterClient] * _startValuesGameConfig.HEALTH_UPGRADE_ADDING_BISHOP;
    ...
    internal int SimplePowerDamage(params int[] xy)
    {
        ...
        switch (_eGM.CellUnitEnt_UnitTypeCom(xy).UnitType)
        {
            ...
            case UnitTypes.Pawn:
                return _startValuesGameConfig.SIMPLE_POWER_DAMAGE_PAWN + _eGM.InfoEnt_UpgradeInfoCom.AmountUpgradePawnDict[_eGM.CellUnitEnt_CellOwnerCom(xy).IsMasterClient] * _startValuesGameConfig.DAMAGE_UPGRADE_ADDING_PAWN;

            case UnitTypes.Rook:
                return _startValuesGameConfig.SIMPLE_POWER_DAMAGE_ROOK + _eGM.InfoEnt_UpgradeInfoCom.AmountUpgradeRookDict[_eGM.CellUnitEnt_CellOwnerCom(xy).IsMasterClient] * _startValuesGameConfig.DAMAGE_UPGRADE_ADDING_ROOK;

            case UnitTypes.Bishop:
                return _startValuesGameConfig.SIMPLE_POWER_DAMAGE_BISHOP + _eGM.InfoEnt_UpgradeInfoCom.AmountUpgradeBishopDict[_eGM.CellUnitEnt_CellOwnerCom(xy).IsMasterClient] * _startValuesGameConfig.DAMAGE_UPGRADE_ADDING_BISHOP;
