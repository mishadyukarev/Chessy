...
namespace Assets.Scripts.Workers.Game.Else
{
    ...
    {
        private static AvailableCellsDataContainerEnts _availableCellEntsContainer;

        internal AvailableCellsEntsWorker(AvailableCellsDataContainerEnts availableCellEntsContainer)
        {
