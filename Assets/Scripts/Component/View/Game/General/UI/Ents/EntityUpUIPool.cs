...
namespace Game.Game
{
    public readonly struct EntityUpUIPool
    {
        ...
        public EntityUpUIPool(in WorldEcs curGameW)
        {
            ...
            _ents[UpEntTypes.Leave] = curGameW.NewEntity()
                .Add(new ButtonVC(CanvasC.FindUnderCurZone<Button>("ButtonLeave")));
            ...
            _ents[UpEntTypes.Alpha] = curGameW.NewEntity()
                .Add(new ButtonVC(upZone_GO.transform.Find("Alpha_Button").GetComponent<Button>()));
        }
