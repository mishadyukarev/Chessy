...
namespace Game.Game
{
    public readonly struct EntityVPool
    {
        ...
        public EntityVPool(in WorldEcs gameW, out List<object> actions, out Dictionary<ClipTypes, System.Action> action0, out Dictionary<UniqueAbilityTypes, System.Action> action1)
        {
