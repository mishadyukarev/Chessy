...
namespace Game.Game
{
    public readonly struct CellEsWorker
    {
        ...
        public CellEsWorker(in CellEs[] cellEs)
        {
            _cellEs = cellEs;
        ...
        public DirectTypes GetDirect(byte idx_from, byte idx_to) => GetDirect(CellEs(idx_from).CellE.XyC.Xy, CellEs(idx_to).CellE.XyC.Xy);
