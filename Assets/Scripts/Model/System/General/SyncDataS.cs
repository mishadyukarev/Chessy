...
namespace Chessy.Model.System
{
    sealed class SyncDataS : SystemModelAbstract
    {
        ...
        internal void TrySyncDataM()
        {
            ...
            if (_eCopy.CenterCloudCellIdx != _e.CenterCloudCellIdx)
            {
                _eCopy.CenterCloudCellIdx = _e.CenterCloudCellIdx;
                needUpdateElse = true;
            }
        ...
        internal void SyncEverythingM()
        {
            //SyncM(SyncTypes.Else);

            //for (var syncT = (SyncTypes)1; syncT < SyncTypes.Else; syncT++)
            //{
