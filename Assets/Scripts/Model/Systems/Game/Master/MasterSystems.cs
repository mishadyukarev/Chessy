...
namespace Chessy.Game.Model.System
{
    sealed class MasterSystems
    {
        ...
        internal readonly TryGiveWaterToUnitsAroundRainyMS TryGiveWaterToUnitsAroundRainyS_M;
        ...
        internal MasterSystems(in SystemsModelGame sMG, in EntitiesModelGame eMG)
        {
            ...
            TryGiveWaterToUnitsAroundRainyS_M = new TryGiveWaterToUnitsAroundRainyMS(sMG, eMG);
