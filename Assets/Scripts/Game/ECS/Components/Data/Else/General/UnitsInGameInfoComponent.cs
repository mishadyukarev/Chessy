...
//        internal List<byte> GetLixtIdxUnits(UnitTypes unitType, bool key) => _amountUnitsInGame[unitType][key].Copy();
...
//        internal bool IsSettedKing(bool key) => GetLixtIdxUnits(UnitTypes.King, key).Count > 0;
//    }
//}
