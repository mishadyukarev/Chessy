...
namespace Scripts.Game
{
    internal struct CellsAttackC
    {
        ...
        internal static List<byte> GetListCopy(PlayerTypes playerType, AttackTypes attackType, byte idxCell) => _cellsForAttack[playerType][attackType][idxCell].Copy();
        internal static bool FindByIdx(PlayerTypes playerType, AttackTypes attackType, byte idxCell, byte idxForFind)
        {
        ...
        internal static void Add(PlayerTypes playerType, AttackTypes attackType, byte idxCell, byte value) => _cellsForAttack[playerType][attackType][idxCell].Add(value);
        internal static void Clear(PlayerTypes playerType, AttackTypes attackType, byte idxCell) => _cellsForAttack[playerType][attackType][idxCell].Clear();
    }
}
