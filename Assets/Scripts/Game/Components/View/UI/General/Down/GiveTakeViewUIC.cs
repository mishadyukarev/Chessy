...
{
    internal struct GiveTakeViewUIC
    {
        ...
        internal GiveTakeViewUIC(GameObject downZone_GO)
        {
        ...
        internal static void SetView_ButtonImage(ToolWeaponTypes giveTakeType, bool isActive)
        {
        ...
        internal static void AddListUpgradeButton(UnityAction unityAction) => _upgradeUnit_But.onClick.AddListener(unityAction);
        internal static void AddList_Button(ToolWeaponTypes giveTakeType, UnityAction unityAction) => _toolAndWeapon_Buts[giveTakeType].onClick.AddListener(unityAction);

        internal static void SetText(ToolWeaponTypes giveTakeType, string text) => _toolWeaponAmount_texsMPs[giveTakeType].text = text;
        internal static void SetImage(ToolWeaponTypes giveTakeType, LevelTWTypes levelTWType)
        {
