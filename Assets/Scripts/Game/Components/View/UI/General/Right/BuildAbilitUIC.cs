...
namespace Scripts.Game
{
    internal struct BuildAbilitUIC
    {
        ...
        internal static void SetActive_Button(BuildButtonTypes buildingButtonType, bool isActive) => _building_Buttons[buildingButtonType].gameObject.SetActive(isActive);


        internal static void SetSpriteThird(SpriteGameTypes spriteGameType) => _third_Image.sprite = SpritesResComCom.Sprite(spriteGameType);

        internal static void AddListener_Button(BuildButtonTypes buildingButtonType, UnityAction unityAction) => _building_Buttons[buildingButtonType].onClick.AddListener(unityAction);
    }
}
