...
{
    internal struct MistakeViewUIC
    {
        ...
        internal MistakeViewUIC(GameObject centerZone_GO)
        {
        ...
        internal static void ActiveBackgroud(bool isActive) => _backgroud_GO.SetActive(isActive);

        internal static void ActiveTextZone(bool isActive) => _textZone_GO.SetActive(isActive);
        internal static void ActiveNeedSteps(bool isActive) => _needStepZone_GO.SetActive(isActive);
        internal static void ActiveNeedMoreHealth(bool isActive) => _needMoreHealth_GO.SetActive(isActive);
        internal static void ActiveNeedOtherPlace(bool isActive) => _needOtherPlace_GO.SetActive(isActive);
        internal static void ActiveNeedCity(bool isActive) => _needCity_GO.SetActive(isActive);
        internal static void ActiveThatsForOtherUnit(bool isActive) => _thatsForOtherUnit_GO.SetActive(isActive);
        internal static void ActiveNearBorderZone(bool isActive) => _nearBorder_GO.SetActive(isActive);

        internal static void SetActiveRes(ResourceTypes resType, bool isActive) => _needAmountRes_TextMP[resType].transform.parent.gameObject.SetActive(isActive);
        internal static void SetText(ResourceTypes resType, string text) => _needAmountRes_TextMP[resType].text = text;
    }
}
