...
namespace Scripts.Game
{
    public struct EconomyViewUIC
    {
        ...
        public static void SetMainText(ResourceTypes resType, string text) => _amountRes_TextMP[resType].text = text;
        public static void SetMainColor(ResourceTypes resType, Color color) => _amountRes_TextMP[resType].color = color;

        public static void SetAddText(ResourceTypes resType, string text) => _amountAddRes_TextMP[resType].text = text;
    }
}
