...
namespace Scripts.Game
{
    ...
    {
        private Dictionary<ResourceTypes, TextMeshProUGUI> _amountRes_TextMP;
        private Dictionary<ResourceTypes, TextMeshProUGUI> _amountAddRes_TextMP;
        ...
        internal void SetMainText(ResourceTypes resType, string text) => _amountRes_TextMP[resType].text = text;
        internal void SetMainColor(ResourceTypes resType, Color color) => _amountRes_TextMP[resType].color = color;

        internal void SetAddText(ResourceTypes resType, string text) => _amountAddRes_TextMP[resType].text = text;
    }
}
