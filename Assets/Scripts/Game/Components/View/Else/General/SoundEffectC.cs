...
{
    internal struct SoundEffectC
    {
        private static Dictionary<SoundEffectTypes, AudioSource> _soundEffect_AudSources;

        internal SoundEffectC(GameObject audioSourceParent_GO)
        {
        ...
        internal static void Play(SoundEffectTypes soundEffectType) => _soundEffect_AudSources[soundEffectType].Play();
        internal static bool IsPlaying(SoundEffectTypes soundEffectType) => _soundEffect_AudSources[soundEffectType].isPlaying;
        internal static void Mute(SoundEffectTypes soundEffectType, bool isMuted) => _soundEffect_AudSources[soundEffectType].mute = isMuted;
    }
}
