...
{
    internal struct CameraC
    {
        private static Camera _camera;
        private static Vector3 _gamePosCamera;

        internal CameraC(Camera camera, Vector3 gamePosCamera)
        {
            _camera = camera;
            _gamePosCamera = gamePosCamera;
        }

        internal static void SetPosRotClient(PlayerTypes playerType, Vector3 posMain)
        {
