...
namespace Chessy.Game
{
    public sealed class EntitiesModel
    {
        ...
        public EntitiesModel(in List<object> forData, in List<string> namesMethods)
        {
            ...
            var windC = new WindC(StartValues.DIRECT_WIND, StartValues.STRENGTH_WIND, StartValues.MAX_STREANGTH_WIND, StartValues.MIN_SNREANGTH_WIND);
            var sunC = new SunC(StartValues.SUN_SIDE);
            var cloundC = new CloudC(StartValues.START_CLOUD);
            WeatherE = new WeatherE(windC, sunC, cloundC);
            ...
            SelectedE = new SelectedE(new SelectedToolWeaponC(StartValues.SELECTED_TOOL_WEAPON, StartValues.SELECTED_LEVEL_TOOL_WEAPON));
