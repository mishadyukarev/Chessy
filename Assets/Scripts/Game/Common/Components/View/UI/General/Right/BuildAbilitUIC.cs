...
namespace Scripts.Game
{
    public struct BuildAbilitUIC
    {
        ...
        public static void SetSpriteThird(SpriteGameTypes spriteGameType) => _third_Image.sprite = SpritesResComCom.Sprite(spriteGameType);
