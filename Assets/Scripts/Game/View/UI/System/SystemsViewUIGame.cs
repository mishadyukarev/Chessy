...
{
    public struct SystemsViewUIGame : IEcsRunSystem
    {
        float _timer;
        ...
        public SystemsViewUIGame(in EntitiesModelCommon eMCommon, in EntitiesViewUIGame eUIGame, in EntitiesModelGame eMGame) : this()
        {
            _eMCommon = eMCommon;
            _eUIGame = eUIGame;
            _eMGame = eMGame;
